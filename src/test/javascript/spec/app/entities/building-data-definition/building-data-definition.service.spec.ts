...
describe('Service Tests', () => {
    ...
    describe('BuildingDataDefinition Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BuildingDataDefinitionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/building-data-definitions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BuildingDataDefinition', () => {
